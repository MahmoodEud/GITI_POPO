    ...
    public partial class testingone : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Studet_Id = table.Column<int>(type: "int", nullable: false),
                    Assignemt_Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAssignments", x => new { x.Studet_Id, x.Assignemt_Id });
                    table.ForeignKey(
                        name: "FK_StudentAssignments_Assignments_Assignemt_Id",
                        column: x => x.Assignemt_Id,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAssignments_Students_Studet_Id",
                        column: x => x.Studet_Id,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentQuizzes", x => new { x.Student_Id, x.Quiz_Id });
                    table.ForeignKey(
                        name: "FK_StudentQuizzes_Quizzes_Quiz_Id",
                        column: x => x.Quiz_Id,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentQuizzes_Students_Student_Id",
                        column: x => x.Student_Id,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAssignments_Assignemt_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentQuizzes_Quiz_Id",
