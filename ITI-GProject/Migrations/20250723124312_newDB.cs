        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbstructVideo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subscription = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Starting_At = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttemptsNumber = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentAttempts_Students_StudentId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttempts_StudentId1",
                table: "StudentAttempts",
                column: "StudentId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentResponses_AttemptId",
                table: "StudentResponses",
                column: "AttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentResponses_ChoiceId",
                table: "StudentResponses",
                column: "ChoiceId");
